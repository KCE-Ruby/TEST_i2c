...
{ .scan_mask = ADC_MASK_CHANNEL_1 | ADC_MASK_CHANNEL_2 | 0, .scan_mask_group_b = 0, .priority_group_a =
...
iic_master_instance_ctrl_t EEPROM_ctrl;
const iic_master_extended_cfg_t EEPROM_extend =
...
const i2c_master_cfg_t EEPROM_cfg =
{ .channel = 0, .rate = I2C_MASTER_RATE_STANDARD, .slave = 0x50, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
...
#endif
  .ipl = (2),
  .p_extend = &EEPROM_extend, };
/* Instance structure to use this module. */
const i2c_master_instance_t EEPROM =
{ .p_ctrl = &EEPROM_ctrl, .p_cfg = &EEPROM_cfg, .p_api = &g_i2c_master_on_iic };
